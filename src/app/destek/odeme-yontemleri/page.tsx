            ...
            <section className="pt-48 pb-24 px-6">
                <div className="max-w-[1000px] mx-auto">
                    ...
                    >
                        ...
                        <p className="text-foreground/40 max-w-xl mx-auto font-sans text-xl leading-relaxed">
                            {isTurkish
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="p-10 border border-border/5 bg-card rounded-3xl">
                            ...
                            <h3 className="text-2xl font-display font-bold text-foreground mb-4 uppercase">{isTurkish ? "KREDİ KARTI" : "CREDIT CARD"}</h3>
                        ...
                        <div className="p-10 border border-border/5 bg-card rounded-3xl">
                            ...
                            <h3 className="text-2xl font-display font-bold text-foreground mb-4 uppercase">{isTurkish ? "HAVALE / EFT" : "BANK TRANSFER"}</h3>
                            <p className="text-foreground/40 font-sans leading-relaxed">
                                {isTurkish
                    ...
                    <div className="mt-16 bg-foreground/5 rounded-3xl p-12 border border-border/10 flex items-center gap-8 flex-col md:flex-row text-center md:text-left">
                        <div className="w-16 h-16 rounded-full bg-silver/10 flex items-center justify-center text-silver shrink-0">
                            <ShieldCheck size={32} />
                        </div>
                        <div>
                            <h4 className="text-xl font-display font-bold text-foreground mb-2 uppercase">{isTurkish ? "256-BIT SSL GÜVENLİĞİ" : "256-BIT SSL SECURITY"}</h4>
                            <p className="text-foreground/40 font-sans leading-relaxed">
                                {isTurkish
