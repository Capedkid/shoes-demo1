            ...
            <section className="pt-48 pb-24 px-6">
                <div className="max-w-[1000px] mx-auto">
                    ...
                    >
                        ...
                        <p className="text-white/40 max-w-2xl font-sans text-xl leading-relaxed">
                            {isTurkish
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        <div className="p-10 border border-white/5 bg-white/[0.01] rounded-3xl">
                            <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-silver mb-8">
                                <Clock size={24} />
                            </div>
                            <h3 className="text-2xl font-display font-bold text-white mb-4 uppercase">{isTurkish ? "30 GÜN SÜRE" : "30-DAY WINDOW"}</h3>
                        ...
                        <div className="p-10 border border-white/5 bg-white/[0.01] rounded-3xl">
                            ...
                            <h3 className="text-2xl font-display font-bold text-white mb-4 uppercase">{isTurkish ? "KOLAY DEĞİŞİM" : "EASY EXCHANGE"}</h3>
                            <p className="text-white/40 font-sans leading-relaxed">
                                {isTurkish
                    ...
                    <div className="bg-white/5 rounded-3xl p-12 border border-white/10">
                        <h2 className="text-2xl font-display font-bold text-white mb-8 uppercase">{isTurkish ? "İADE KOŞULLARI" : "RETURN CONDITIONS"}</h2>
                        <ul className="flex flex-col gap-6">
                            {[
                                ...
                                <li key={idx} className="flex gap-4 items-start text-white/60 font-sans">
